...
local function downloadFile(path, func)
  if not isfile(path) then
    local suc, res = pcall(function()
      return game:HttpGet(
      'https://raw.githubusercontent.com/renderintent/LunarVape/' ..
  ...
  vape:Clean(playersService.LocalPlayer.OnTeleport:Connect(function()
    if (not teleportedServers) and (not _G.VapeIndependent) then
      ...
      if _G.VapeDeveloper then
        ...
        loadstring(game:HttpGet('https://raw.githubusercontent.com/renderintent/LunarVape/main/loader.lua', true), 'loader')()
      end
      ]]
      if _G.VapeDeveloper then
